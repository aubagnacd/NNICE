...
int main(int argc, char** argv) {
    ...
    if (c == "ReLU") {
        ...
        net->ImportNN_pt_custom("NNs/5x20_ReLU/model_pt_custom.h5");
        vect = new VectInference();
        vect->ImportNN_pt_custom("NNs/5x20_ReLU/model_pt_custom.h5");
        ...
        net = new SnglInference();
        net->ImportNN_pt_custom("NNs/2x80_tanh/model_pt_custom.h5", "", "dense_layer_", "", "output_layer");
        vect = new VectInference();
        vect->ImportNN_pt_custom("NNs/2x80_tanh/model_pt_custom.h5", "", "dense_layer_", "", "output_layer");
        ...
        net = new SnglInference();
        net->ImportNN_pt_custom("NNs/250ResBlock_swish/model_pt_custom.h5", "backbone", "", "hidden_residual_block_", "output_layer");
        vect = new VectInference();
        vect->ImportNN_pt_custom("NNs/250ResBlock_swish/model_pt_custom.h5", "backbone", "", "hidden_residual_block_", "output_layer");
